            ...
            <div class="column1">
                ...
                if ($resultEmployee && $resultEmployee->num_rows > 0) {
                    ...
                    echo "</table>";
                        ...
                        echo "<table border='1'>";
                        echo "<tr>
                        <th rowspan='2' style ='width: 50px;'>Date / Weekday</th>
                        <th colspan='2' style ='text-align: center;'>Before Noon</th>
                        <th colspan='2' style ='text-align: center;'>After Noon</th>                        
                        <th colspan='2' style ='text-align: center;'>Overtime</th>
                        </tr>";
                        echo "<tr><th>In</th><th>Out</th><th>In</th><th>Out</th><th>In</th><th>Out</th></tr>";
