...
<body>
    ...
    <div class="content" id="contentContainer">
        ...
        <div class="attendance-table-card" style="float: left; width: 37%;">
        ...
        <div class="attendance-table-card" style="float: right; width: 63%;">
        <h3>Calendar</h3>
        <?php
            ...
            function generateCalendar($month, $year) {
                ...
                echo '<table class="calendar-table" style="width: 90%; border-collapse: collapse; margin: 20px; background-color: #f0f0f0; border: 1px solid #ddd; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">';
                ...
                for ($day = 1; $day <= $daysInMonth; $day++) {
                    ...
                    echo '<td style="padding: 10px; text-align: center; font-weight: ' . ($isHoliday ? 'bold' : 'normal') . ';' . $cellStyle . '">';
